...
public class ChannelAPI {
    ...
    private static class TalkMessageParser {
        ...
        public TalkMessageParser(HttpResponse resp) throws ChannelException {
            try {
                ...
                mReader = new BufferedReader( new InputStreamReader( ins, Charset.forName("UTF-8") ) );
        ...
        private String readSubmission() throws ChannelException {
            try {
                ...
                return StringEscapeUtils.unescapeJava(new String(chars));
            } catch (IOException e) {
                throw new ChannelException(e);
    ...
    public boolean send(String message, String urlPattern) throws IOException {
        ...
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("channelKey", "key"));
     ...
     * @throws IOException
     */
    public static XHR sendPost(String url, List<NameValuePair> params) throws IOException {
